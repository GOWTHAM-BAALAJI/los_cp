            ...
            child: Row(
              ...
              children: [
                ...
                Container(
                  child: Row(
                    children: [
                      Icon(Icons.file_download_outlined, size: 24, color: Color(0xFFD97700),),
                      SizedBox(width: 8),
                      Text("Download", style: TextStyle(fontSize: 12, fontWeight: FontWeight.w400, color: Color(0xFF1E1E1E), fontFamily: "Lato"),)
                    ],
                  ),
                ),
              ],
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              widget.name,
                              style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: Color(0xFF2051E5), fontFamily: "Lato"),
                            ),
                            SizedBox(height: 8),
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text("ID: ${widget.id}", style: TextStyle(fontSize: 12, color: Color(0xFF101010), fontFamily: "Lato", fontWeight: FontWeight.w500)),
                                Row(
                                  children: [
                                    Icon(Icons.phone, size: 16, color: Colors.orange),
                                    SizedBox(width: 4),
                                    Text(widget.phone, style: TextStyle(fontSize: 12, color: Color(0xFF101010), fontFamily: "Lato", fontWeight: FontWeight.w500)),
                                  ],
                                ),
                              ],
                            ),
                            ...
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text("Insurance Premium: ₹${widget.insurancePremium}", style: TextStyle(fontSize: 12, color: Color(0xFFD97700), fontFamily: "Lato", fontWeight: FontWeight.w700),),
                                Container(
                                    width: 1.5,
                                    height: 30,
                                    color: Color(0xFFD97700)
                                ),
                                Text("Loan Amount: ₹${widget.loanAmount}", style: TextStyle(fontSize: 12, color: Color(0xFFD97700), fontFamily: "Lato", fontWeight: FontWeight.w700),)
                              ],
                            )
                          ],
                        ),
